...
The fully additive model, full_additive_mod, did not work because it captured neither the nonlinearity nor the interactions in our model.  As stated above, the element of the model that by far improved model fit the most was the log transformation of the response realSum which is the price of the listed room.  
